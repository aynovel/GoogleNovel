...
public class TrendingsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TrendingsAdapter(Context context, List<DiscoverBean.ResultData> contactList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int positions) {
        ...
        if (holder instanceof ViewHolderOne) {
            ...
            if (list_path != null && list_path.size() > 0) {
                ...
                ((ViewHolderOne) holder).mBanner.setIndicatorGravity(BannerConfig.RIGHT);
                ((ViewHolderOne) holder).mBanner.start();
                ((ViewHolderOne) holder).mBanner.setOnBannerClickListener(new OnBannerClickListener() {
                    @Override
                    public void onBannerClick(List datas, int position) {
                        ReadIntent(positions, position);
            ...
            TrendingRVAdapter mTwoRVAdapter = new TrendingRVAdapter(mContext, TYPE_TWO, mContactList.get(positions).list, null, mContactList.get(positions).rec_id,mContactList.get(positions).isimg,mContactList.get(positions).recimg);
            ...
            TrendingRVAdapter mThreeRVAdapter = new TrendingRVAdapter(mContext, TYPE_THREE, mContactList.get(positions).list, null, mContactList.get(positions).rec_id,mContactList.get(positions).isimg,mContactList.get(positions).recimg);
            ...
            TrendingRVAdapter mGridRecylerViewAdapter = new TrendingRVAdapter(mContext, TYPE_FOUR, mContactList.get(positions).list, null, mContactList.get(positions).rec_id,mContactList.get(positions).isimg,mContactList.get(positions).recimg);
            ...
            GlideUtil.picCache(mContext,bean.recimg,bean.wid + "small",R.drawable.default_work_cover, ((ViewHolderFive) holder).mRoundImageView);
...
//            }
            ...
            GlideUtil.picCache(mContext,bean.recimg,bean.wid + "small",R.drawable.default_work_cover, ((ViewHolderSix) holder).mRoundImageView);
...
//            }
            ...
            TrendingRVAdapter mSixRVAdapter = new TrendingRVAdapter(mContext, TYPE_SIX, mContactList.get(positions).list, null, mContactList.get(positions).rec_id,mContactList.get(positions).isimg,mContactList.get(positions).recimg);
            ...
            TrendingRVAdapter mSevenRVAdapter = new TrendingRVAdapter(mContext, TYPE_SEVEN, mContactList.get(positions).list, null, mContactList.get(positions).rec_id,mContactList.get(positions).isimg,mContactList.get(positions).recimg);
            ...
            TrendingRVAdapter mEightRVAdapter = new TrendingRVAdapter(mContext, TYPE_EIGHT, mContactList.get(positions).list, null, mContactList.get(positions).rec_id,mContactList.get(positions).isimg,mContactList.get(positions).recimg);
            ...
            TrendingRVAdapter mNineRVAdapter = new TrendingRVAdapter(mContext, TYPE_NINE, mContactList.get(positions).list, mContactList.get(positions).list.get(0).tag_list, mContactList.get(positions).rec_id,mContactList.get(positions).isimg,mContactList.get(positions).recimg);
