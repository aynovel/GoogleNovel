...
public class TrendingRVAdapter extends RecyclerView.Adapter<TrendingRVAdapter.RecomHolder> {
    ...
    private String mBid;//mTid推荐位id;  mBid书籍id
    private final String mIsimg;//是否显示推荐为logo  1是  0否
    private final String mLogoUrl;//推荐位logo

    public TrendingRVAdapter(Context context, int type, List<DiscoverBean.ResultData.list> mContentList, List<DiscoverBean.ResultData.list.tag_list> tag_list, String Tid,String mIsimg,String logoUrl) {
        super();
    ...
    public void onBindViewHolder(@NonNull final RecomHolder holder, final int position) {
        ...
        if (mType == TrendingsAdapter.TYPE_NINE) {
            bean = mList.get(0);
        } else {
...
//            GlideUtil.recommentLoad(mContext, bean.wid + "small", bean.recimg, bean.recimg, R.drawable.default_work_cover, holder.mCover);
//        } else {
//            GlideUtil.recommentLoad(mContext, "", cover, bean.recimg, R.drawable.default_work_cover, holder.mCover);
//        }
        switch (mType) {
            case TrendingsAdapter.TYPE_TWO:
                ...
                break;
            case TrendingsAdapter.TYPE_THREE:
...
//                }
                break;
            case TrendingsAdapter.TYPE_FOUR:
                if (mIsimg != null && mIsimg.equals("1")){
                    // GlideUtil.load(mContext,mLogoUrl, R.drawable.add_book_rack,holder.mImgLogo);
                    Glide.with(mContext).load(mLogoUrl).into(holder.mImgLogo);
                    holder.mImgLogo.setVisibility(View.VISIBLE);
                ...
                break;
            case TrendingsAdapter.TYPE_SIX:
...
//                }
                ...
                holder.mBookName.setText(bean.title);
                break;
            case TrendingsAdapter.TYPE_SEVEN:
                holder.mBookName.setText(bean.title);
                ...
                break;
            case TrendingsAdapter.TYPE_EIGHT:
...
//                }
                ...
                break;
            case TrendingsAdapter.TYPE_NINE:
