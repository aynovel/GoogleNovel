        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                for (int i = 0; i < mActiveViews.size(); ++i) {
                    ...
                    LogUtils.d("tmpView frame ======== " + i + " ===== " + tmpView.destRect.top + " H=== " + (tmpView.destRect.bottom - tmpView.destRect.top));
//                    canvas.drawBitmap(tmpView.bitmap, tmpView.srcRect, tmpView.destRect, null);
    ...
    public void draw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 26){
            ...
            canvas.clipRect(0, 0, mViewWidth, mViewHeight, Region.Op.REPLACE);
        }
/*        //设置背景透明
