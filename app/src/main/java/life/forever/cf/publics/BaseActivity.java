...
public abstract class BaseActivity extends AppCompatActivity implements Constant {
    ...
    protected View mLoadingLayout; //加载动画
...
//        }
    ...
    private void showPhoneRational() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(BaseActivity.this, Manifest.permission.READ_PHONE_STATE)) {
...
//        MobclickAgent.onPause(context);
    ...
    public void setBackGroudColor(int backGroudColor)
    {
        if(mRootLayout != null)
        {
            mRootLayout.setBackgroundColor(backGroudColor);
        }
    }
