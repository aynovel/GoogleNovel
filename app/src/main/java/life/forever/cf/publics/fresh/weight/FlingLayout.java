...
import life.forever.cf.publics.fresh.android.androidanim.AnimGetter;
import life.forever.cf.publics.fresh.android.androidanim.AnimListener;
import life.forever.cf.publics.fresh.android.overscroll.OverScrollController;
import life.forever.cf.publics.fresh.android.resolver.FlingXResolver;
import life.forever.cf.publics.fresh.android.resolver.FlingYResolver;
import life.forever.cf.publics.fresh.android.resolver.IEventResolver;
...
public class FlingLayout extends FrameLayout implements NestedScrollingChild, NestedScrollingParent {
    ...
    private final boolean canOverScroll = true;
    ...
    public void setOrientation(@OrientationMode int orientation) {
        ...
        if (orientation == HORIZONTAL) {
            MAX_DISTANCE = ScreenUtil.getScreenWidth(getContext()) * 3 / 5;
            eventResolver = new FlingXResolver(flingLayoutContext);
        } else if (orientation == VERTICAL) {
            MAX_DISTANCE = ScreenUtil.getScreenHeight(getContext()) * 3 / 5;
    ...
    public int getMaxDistance() {
        return maxDistance > 0 ? maxDistance : MAX_DISTANCE;
    }
