...
import life.forever.cf.publics.fresh.android.able.OnEndListener;
import life.forever.cf.publics.fresh.android.able.Pullable;
import life.forever.cf.publics.fresh.android.able.Refreshable;
import life.forever.cf.publics.fresh.android.androidanim.AnimListener;
import life.forever.cf.publics.fresh.android.type.LayoutType;
...
public abstract class BaseHeaderView extends RelativeLayout implements Refreshable {
    ...
    public boolean onStartRelease(float nowY) {
        float headerSpanHeight = getSpanHeight();
        if (nowY >= headerSpanHeight && onRefreshListener != null) {
