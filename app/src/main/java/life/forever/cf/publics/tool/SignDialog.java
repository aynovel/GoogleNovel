...
public class SignDialog extends Dialog implements View.OnClickListener {
    ...
    public SignDialog(final Context context, SignBean.ResultData signbean) {
...
//        }
        ...
        SignRVAdapter mSignRVAdapter = new SignRVAdapter(mContext, signbean);
        GridLayoutManager mGridLayoutManager = new GridLayoutManager(mContext, 4, RecyclerView.VERTICAL, false);
        ...
        mRecyclerView.setAdapter(mSignRVAdapter);
    }
