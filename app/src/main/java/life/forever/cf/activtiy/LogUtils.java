...
public class LogUtils {
    public static Boolean LOG_SWITCH = false; // 日志文件总开关
    private static Boolean LOG_TO_FILE = false; // 日志写入文件开关
    private static String LOG_TAG = "Reader"; // 默认的tag
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + PlotRead.getContext().getPackageName();
        LOG_FILE_NAME = "Log";
    }
    ...
    public static void adI(Object msg) {
        i("广告", msg, null);
    }
